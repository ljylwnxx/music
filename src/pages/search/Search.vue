...
export default {
  ...
  methods: {
    search () {
      this.isLoading = true
      httpGet(`/api/cloudsearch?limit=30&offset=${this.searchInfo.offset}&type=${this.searchInfo.type}&keywords=${this.searchInfo.keywords}`).then(res => {
        ...
        switch (this.vIndex) {
          case 0:
            this.searchList.musicList = res.data.result.songs.map(item => {
              return tranferMusicData(item)
            })
            this.total = res.data.result.songCount
            break
          case 1:
            this.searchList.albumList = res.data.result.albums
            this.total = res.data.result.albumCount
            break
          case 2:
            this.searchList.artistList = res.data.result.artists
            this.total = res.data.result.artistCount
            break
          case 3:
            this.searchList.playList = res.data.result.playlists
            this.total = res.data.result.playlistCount
            break
          case 4:
            this.searchList.userList = res.data.result.userprofiles
            this.total = res.data.result.userprofileCount
            break
          case 5:
            this.searchList.mvList = res.data.result.mvs
